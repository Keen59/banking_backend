...
public class IncomingFastPaymentAuthorizationTests
{
    [Fact]
    public void Create_requires_payments_credit_policy()
    {
        var method = typeof(IncomingFastPaymentsController).GetMethod(nameof(IncomingFastPaymentsController.Create));
